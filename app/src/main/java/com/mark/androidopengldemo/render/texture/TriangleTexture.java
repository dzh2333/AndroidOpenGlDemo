package com.mark.androidopengldemo.render.texture;
...
/**
 * https://blog.csdn.net/qq_36391075/article/details/81564454
 */
public class TriangleTexture {
    ...
    private void initShder(){
        int vs = ShaderHelper.compileVertexShader(mVertexShader);
        int fs = ShaderHelper.compileFragmentShader(mFragmentShader);

        mProgram = ShaderHelper.linkProgram(vs, fs);
